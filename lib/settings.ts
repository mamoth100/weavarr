...
export const SETTINGS_SCHEMA: SettingField[] = [
  ...
  { key: 'ENABLE_EPISODE_WARN', label: 'Big Add Warning', group: 'App Behavior', secret: false, type: 'boolean', defaultValue: 'true', info: 'When selecting seasons or episodes to add would download a pile of episodes, the app warns you the moment the count crosses the line, so one click can\'t accidentally queue a whole 200-episode series. The number sets how many episodes count as a pile. Default 30, must be at least 1. Applies immediately, no restart needed.' },
