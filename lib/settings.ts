...
export const SETTINGS_SCHEMA: SettingField[] = [
  ...
  { key: 'WEBPUSH_NOTIFY_IMPORTS', label: 'Send "Ready to Watch" Pings', group: 'Webpush', secret: false, type: 'boolean', defaultValue: 'true' },
  { key: 'WEBPUSH_NOTIFY_ALERTS', label: 'Send Error Alerts', group: 'Webpush', secret: false, type: 'boolean', defaultValue: 'true' },
